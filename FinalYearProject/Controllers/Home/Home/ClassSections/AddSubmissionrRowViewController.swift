//
//  AddSubmissionrRowViewController.swift
//  FinalYearProject
//
...
class AddSubmissionrRowViewController: UIViewController {
    ...
    private let AboutView = AboutSpecificBody(title: "Add a Submission Page", FontSize: 30)
    ...
    public func CreateNewSection(with Title: String, Body: String, ClassID: String, completion: @escaping (Bool) -> Void){
        ...
        UserIDPath.observeSingleEvent(of: .value, with: { snapshot in
            ...
            if var Chats = UsersNode["Submissions"] as? [[String: Any]] {
