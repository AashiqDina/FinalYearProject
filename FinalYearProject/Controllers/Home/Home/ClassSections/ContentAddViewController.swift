//
//  ContentAddViewController.swift
//  FinalYearProject
//
...
class ContentAddViewController: UIViewController, UITextViewDelegate{
    // Create a refernece to the database
    private let TheDatabase = Database.database().reference()
    private var UniqueID = ""
    // Create  a DateFormateet to convert Dates to Strings and returns them as String
    ...
    @objc private func ClickLogin(){
        ...
        self.CreateNewSection(with: AboutTitle, Body: AboutBody, Type: "Page", ClassID: ClassID, completion: { [weak self] success in
